...
/**
 * Work unit expiration time.
 * 
 * The workunits has a expiration time to control if some agent dies or
 * it takes a lot of time to end the workunit can be asigned to other
 * agent.
 */
