...
\begin{table}
	...
	\begin{tabular}{ccccc}
		...
		\hline
	\end{tabular}
	\caption{Ejemplo de generación de una tabla arcoiris}\label{tab:arcoiris}
\end{table}
